  ...
  return (
    <div className="home-container">
      <div id="left">
        ...
        onClick={() => dispatch({ type: "update/gender", payload: "all" })}
      >
        Female
      </button>
      <button
      ...
      >
        Female
          ...
          <Link className="user-link f-user" to="/register">Female</Link>
          <Link className="user-link m-user" to="/about">Male</Link>
        </div> 
      </div>
