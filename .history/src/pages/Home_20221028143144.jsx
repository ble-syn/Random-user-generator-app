...
function Home() {
  ...
  useEffect(() => {
    const female = async () => {
    const res = await fetch("https://randomuser.me/api?results=10&gender=female");
    const data = await res.json();
    setUsers(data.results);
    setLoading(false);
  };
  ...
  useEffect(() => {
    const male = async () => {
    const res = await fetch("https://randomuser.me/api?results=10&gender=male");
    const data = await res.json();
    setUsers(data.results);
    setLoading(false);
  };
